    ...
    VitePWA({
      ...
      workbox: {
        ...
        globIgnores: [
          ...
          "**/sitemap.xml",
          // The Term Board is regenerated by the scraper every morning.
          // Precaching it would pin whichever copy a visitor saw first and
          // quietly defeat the daily refresh.
          "term-board/**",
        ],
        ...
        // /term-board/ is a real static file, not a React route. Without it
        // here the navigation fallback hands that URL the SPA shell, and the
        // router — finding no matching route — renders the 404 page.
