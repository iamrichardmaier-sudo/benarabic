...
const saved: LibraryText[] = [
  { id: 'a', title: 'نص محفوظ', body: 'كلمات', coverUrl: 'data:image/jpeg;base64,xxx', updatedAt: '2026-09-15' },
  { id: 'b', title: 'بدون غلاف', body: 'كلمات', coverUrl: null, updatedAt: '2026-09-14' },
];
